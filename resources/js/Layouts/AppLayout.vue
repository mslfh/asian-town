...
<template>
    <q-layout view="lHh Lpr lFf">
        ...
        >
        <q-scroll-area q-scroll-area style="height: calc(100% - 80px); padding: 10px; margin-top: 80px; border-right: 1px solid #ddd">
                            <q-list>
                                <q-item
                                    to="/"
                                ...
                                >
                                    ...
                                    <q-item-section>
                                        <q-item-label
                                            >Product Catalogues</q-item-label
                                        >
                                    </q-item-section>
                                </q-item>
                                <q-expansion-item
